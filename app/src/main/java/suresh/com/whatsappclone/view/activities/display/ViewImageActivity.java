package suresh.com.whatsappclone.view.activities.display;
...
import suresh.com.whatsappclone.view.activities.profile.ProfileActivity;

import com.com.whatsappclone.databinding.ActivityViewImageBinding;
    ...
    private void getInfo() {
        firestore.collection("Users").document(firebaseUser.getUid()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                Glide.with(ViewImageActivity.this).load(imageProfile).into(binding.imageView);

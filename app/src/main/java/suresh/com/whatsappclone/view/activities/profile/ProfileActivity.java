package suresh.com.whatsappclone.view.activities.profile;
...
import suresh.com.whatsappclone.common.Common;
import com.com.whatsappclone.databinding.ActivityProfileBinding;
import suresh.com.whatsappclone.view.activities.display.ViewImageActivity;
import suresh.com.whatsappclone.view.activities.starup.SplashScreenActivity;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void initActionClick() {
        ...
        binding.lbEditAbout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void showBottomSheetEditAbout(){
            ...
            @SuppressLint("InflateParams") View view = getLayoutInflater().inflate(R.layout.botton_sheet_edit_about, null);
            ...
            final EditText edUserAbout = view.findViewById(R.id.ed_user_about);

            ((View) view.findViewById(R.id.btn_save_about)).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (TextUtils.isEmpty(edUserAbout.getText().toString())){
                        Toast.makeText(getApplicationContext(),"Name can't be empty",Toast.LENGTH_SHORT).show();
                    } else {

                        updateAbout(edUserAbout.getText().toString());
                        bsDialogEditAbout.dismiss();
                    }
                }
            });
    ...
    private void getInfo() {
        firestore.collection("Users").document(firebaseUser.getUid()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                String userAbout = documentSnapshot.getString("userAbout");
    ...
    private void updateName(String newName){
        firestore.collection("Users").document(firebaseUser.getUid()).update("userName",newName).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(getApplicationContext(),"Update Your Name Successful",Toast.LENGTH_SHORT).show();
                getInfo();
            }
        });
    }
    private void updateAbout(String newAbout) {
        firestore.collection("Users").document(firebaseUser.getUid()).update("userAbout",newAbout).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
                Toast.makeText(getApplicationContext(),"Update Your About Successful",Toast.LENGTH_SHORT).show();
                getInfo();
            }
        });
    }

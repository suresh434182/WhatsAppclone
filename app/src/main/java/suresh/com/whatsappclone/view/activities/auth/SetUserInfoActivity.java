package suresh.com.whatsappclone.view.activities.auth;
...
import com.com.whatsappclone.databinding.ActivitySetUserInfoBinding;

import org.jetbrains.annotations.NotNull;

import suresh.com.whatsappclone.model.user.Users;
    ...
    private void uploadToFirebase() {
        if (imageUri!=null){
            ...
            if(firebaseUser!=null){
                ...
                Users users=new Users(userID,binding.edName.getText().toString(),firebaseUser.getPhoneNumber(),"",
                        "","","",
                        "","","");
           ...
           /*StorageReference riversRef = FirebaseStorage.getInstance()
                    .getReference().child("ImagesProfile/" + System
